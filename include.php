<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img/curved-images/curved6.jpg">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" >
        <img src="../assets/img/illustrations/rocket-white.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link hovereffect" href="../pages/dashboard.php">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="https://discord.gg/795r4bgxra">
            <div class="icon icon-shape icon-sm shadow border-radius-md  text-center me-2 d-flex align-items-center justify-content-center">
